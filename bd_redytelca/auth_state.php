...
try {
    // Auto-reparación de esquema eliminada (Prompt 9): sesiones ya es nativa
    // en bd_redytelca.sql desde Fase 0; este CREATE TABLE se ejecutaba en
    // cada polling de 15s de app.js sin necesidad real.
